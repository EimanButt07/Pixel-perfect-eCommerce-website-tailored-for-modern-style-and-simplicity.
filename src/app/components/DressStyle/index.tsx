      ...
      <section className="max-w-frame mx-auto bg-[#F0F0F0] px-6 pb-6 pt-10 md:p-[70px] rounded-[40px] text-center">
        <motion.h2
          ...
          className={cn([
            ...
            "text-[32px] leading-[36px] md:text-5xl mb-8 md:mb-14 ",
          ])}
        >
        ...
        <motion.div
          ...
          className="flex justify-center items-center flex-col sm:flex-row md:h-[289px] space-y-4 sm:space-y-0 sm:space-x-5 mb-4 sm:mb-5"
        >
          <DressStyleCard
            title="Casual"
            url="/shop#casual"
        ...
        <motion.div
          ...
          className="flex justify-center items-center flex-col sm:flex-row md:h-[289px] space-y-5 sm:space-y-0 sm:space-x-5"
        >
          <DressStyleCard
            title="Party"
            url="/shop#party"
